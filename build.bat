...
set "CommonFlags=/nologo /std:c++latest /W4 /WX /wd4201 /wd4251 /wd4324 /EHs-c- /GR- /D_HAS_EXCEPTIONS=0 /DGECKO_BUILD_SHARED=1 /DGECKO_PLATFORM_WINDOWS=1 /DGECKO_GRAPHICS_VULKAN=1 /DGECKO_GRAPHICS_VULKAN_WIN32=1 /D_CRT_SECURE_NO_WARNINGS"
...
cl %CommonFlags% /MP /LD %ConfigFlags% /DGECKO_BUILDING=1 /I"%Root%include" ^
 ...
 /link /IMPLIB:"%BinaryDir%\Gecko.lib" user32.lib shell32.lib shcore.lib ole32.lib winmm.lib %VulkanLibrary%
