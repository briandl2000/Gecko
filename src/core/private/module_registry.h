...
public:
  ...
  [[nodiscard]] ::gecko::ModuleRegistration RegisterStatic(
      ::gecko::IModule& module) noexcept override;

  [[nodiscard]] ::gecko::ModuleResult Unregister(
      ::gecko::Label module) noexcept override;

  [[nodiscard]] ::gecko::IModule* GetModule(
      ::gecko::Label module) noexcept override;

  [[nodiscard]] const ::gecko::IModule* GetModule(
  ...
  [[nodiscard]] bool PublishServiceImpl(::gecko::ServiceId id,
                                        void* impl) noexcept override;
  [[nodiscard]] void* GetServiceImpl(
      ::gecko::ServiceId id) const noexcept override;
  [[nodiscard]] bool UnpublishServiceImpl(
