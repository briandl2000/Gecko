...
namespace Gecko::DX12
{
  ...
  public:
    ...
    virtual RenderTarget GetCurrentBackBuffer() override { return m_BackBuffers[m_CurrentBackBufferIndex]; }
    ...
    virtual u32 GetNumBackBuffers() override { return m_NumBackBuffers; };
    virtual u32 GetCurrentBackBufferIndex() override { return m_CurrentBackBufferIndex; };
