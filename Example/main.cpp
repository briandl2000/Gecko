...
protected:
  virtual void PopulateSceneRenderInfo(Gecko::SceneRenderInfo* sceneRenderInfo) const override
  {
...
public:
  ...
  virtual void Render(const Gecko::SceneRenderInfo& sceneRenderInfo, Gecko::ResourceManager* resourceManager,
