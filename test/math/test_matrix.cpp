...
{
  Float4x4 view = Float4x4::LookAt({0.0f, 0.0f, 5.0f},  // eye
...
{
  Float4x4 ortho = Float4x4::Orthographic(-10.0f, 10.0f,  // left, right
...
{
  Float4x4 persp = Float4x4::Perspective(ToRadians(60.0f),  // fovY
                                         16.0f / 9.0f,      // aspect
                                         0.1f, 100.0f       // near, far
  );
