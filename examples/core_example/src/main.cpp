...
void Example(SimpleAllocator* allocator, runtime::RingProfiler* profiler, runtime::TraceWriter* traceWriter)
{
  GECKO_PROF_FUNC(MAIN_CAT);
  ...
  {
    GECKO_PROF_ZONE(MAIN_CAT, "ExampleScope"); 
...
int main()
{
  ...
  {
    Example(allocator.get(), profiler.get(), traceWriter.get());
