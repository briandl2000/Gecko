...
template <class E> GECKO_API constexpr auto ToUnderlying(E e) noexcept {
...
template <EnumFlag E> GECKO_API constexpr E operator|(E a, E b) noexcept {
...
template <EnumFlag E> GECKO_API constexpr bool Any(E a) noexcept {
