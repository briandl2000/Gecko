...
public:
  ...
  RegisterStatic(::gecko::IModule &module) noexcept override;

  [[nodiscard]] GECKO_API ::gecko::ModuleResult
  Unregister(::gecko::Label module) noexcept override;

  [[nodiscard]] GECKO_API ::gecko::IModule *
  GetModule(::gecko::Label module) noexcept override;

  [[nodiscard]] GECKO_API const ::gecko::IModule *
  GetModule(::gecko::Label module) const noexcept override;
